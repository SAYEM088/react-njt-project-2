        ...
        <div>
            <div className="aboutpara text-center">
                <div><p>I accomplished my education in law and also a master's in
                    Sociology.
                    I am pretty experienced in social compliance in the Readymade garments sector. Therefore I have more than 13
                ...
                <div className="exp"> <div className="thirteen"> 13+ </div>
